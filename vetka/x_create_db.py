...
def create_db():
    ...
    t_massage = models.Category(name='массаж', name_en='massage', deleted=False)
    db.session.add(t_massage)
    t_aromatherapy = models.Category(name='ароматерапия', name_en='aromatherapy', deleted=False)
    db.session.add(t_aromatherapy)
    t_dry_parfum = models.Category(name='твёрдые духи', name_en='dry-parfum', deleted=False, description='''
...
смягчить и увлажнить кожу.''')
    ...
    t_shea = models.Category(name='масло ши', name_en='shea-butter', deleted=False)
    db.session.add(t_shea)
    t_cinnamon = models.Category(name='корица', name_en='cinnamon', deleted=False)
    db.session.add(t_cinnamon)
    t_ubtan = models.Category(name='убтан', name_en='ubtan', deleted=False, description='''
...
нежной и бархатистой!''')
    ...
    t_ayurveda = models.Category(name='аюрведа', name_en='ayurveda', deleted=False)
    db.session.add(t_ayurveda)
    t_clay = models.Category(name='глина', name_en='clay', deleted=False)
    db.session.add(t_clay)
    t_patchouli = models.Category(name='пачули', name_en='patchouli', deleted=False)
    db.session.add(t_patchouli)
    t_mint = models.Category(name='мята', name_en='mint', deleted=False)
    db.session.add(t_mint)
    t_strength = models.Category(name='укрепление', name_en='strength', deleted=False)
    db.session.add(t_strength)
    t_orange = models.Category(name='апельсин', name_en='orange', deleted=False)
    db.session.add(t_orange)
    t_manicure = models.Category(name='маникюр', name_en='manicure', deleted=False)
    db.session.add(t_manicure)
    t_beeswax = models.Category(name='пчелиный воск', name_en='beeswax', deleted=False, description='''
...
очень долго.''')
    ...
    t_ylang2 = models.Category(name='иланг-иланг', name_en='ylang2', deleted=False)
    db.session.add(t_ylang2)
    t_scrub = models.Category(name='скраб', name_en='scrub', deleted=False)
    db.session.add(t_scrub)
    t_lips = models.Category(name='губы', name_en='lips', deleted=False)
    db.session.add(t_lips)
    t_curcuma = models.Category(name='куркума', name_en='curcuma', deleted=False)
    db.session.add(t_curcuma)
    t_coconut = models.Category(name='кокос', name_en='coconut', deleted=False)
    db.session.add(t_coconut)
    t_menthol = models.Category(name='ментол', name_en='menthol', deleted=False)
    db.session.add(t_menthol)
    t_bergamot = models.Category(name='бергамот', name_en='bergamot', deleted=False)
    db.session.add(t_bergamot)
    t_pedicure = models.Category(name='педикюр', name_en='pedicure', deleted=False)
    ...
    g_01 = models.Good(product='Твёрдые духи', name='Мак и мята',
                       ...
                       name_en='dry-parfum-poppy-mint', price=170,
                       tags=[t_aromatherapy, t_dry_parfum, t_mint, t_dry_parfum], deleted=True)
    db.session.add(g_01)
    g_02 = models.Good(product='Массажная плитка', name='Апельсин и корица',
                       ...
                       tags=[t_massage, t_aromatherapy, t_shea, t_cinnamon, t_orange], deleted=False)
    db.session.add(g_02)
    g_03 = models.Good(product='Убтан', name='',
                       ...
                       tags=[t_ubtan, t_ayurveda, t_clay, t_curcuma], deleted=False)
    db.session.add(g_03)
    g_04 = models.Good(product='Твёрдые духи', name='Пачули и мята',
                       ...
                       tags=[t_dry_parfum, t_patchouli, t_mint], deleted=False)
    db.session.add(g_04)
    g_05 = models.Good(product='Воск для ногтей', name='Апельсин и корица', category=c_nails,
                       ...
                       tags=[t_cinnamon, t_strength, t_orange, t_manicure, t_beeswax], deleted=False)
    db.session.add(g_05)
    g_06 = models.Good(product='Воск для кончиков волос', name='Иланг-иланг', category=c_hair,
                       ...
                       tags=[t_beeswax, t_ylang2, t_coconut], deleted=False)
    db.session.add(g_06)
    g_07 = models.Good(product='Бомбочка для ванны', name='Апельсин и мята', category=c_body,
                       ...
                       tags=[t_aromatherapy, t_clay, t_mint, t_orange], deleted=False)
    db.session.add(g_07)
    g_08 = models.Good(product='Масло для кутикулы', name='Иланг-иланг', category=c_nails,
                       ...
                       tags=[t_manicure, t_ylang2], deleted=False)
    db.session.add(g_08)
    ...
    g_11 = models.Good(product='Скраб для губ', name='Мятный шоколад', category=c_face,
                       ...
                       tags=[t_shea, t_mint, t_scrub, t_lips], deleted=False)
    db.session.add(g_11)
    g_12 = models.Good(product='Бальзам для губ', name='Цитрус и мёд', category=c_face,
                       ...
                       tags=[t_shea, t_beeswax, t_lips], deleted=False)
    db.session.add(g_12)
    g_13 = models.Good(product='Гейзер для педикюра', name='Куркума', category=c_nails,
                       ...
                       tags=[t_curcuma, t_coconut, t_pedicure], deleted=False)
    db.session.add(g_13)
    ...
    g_15 = models.Good(product='Скраб для тела', name='Ментол и кокос', category=c_body,
                       ...
                       tags=[t_scrub, t_menthol, t_coconut], deleted=False)
    db.session.add(g_15)
    g_16 = models.Good(product='Твёрдые духи в кулонах', category=c_parfum,
                       ...
                       tags=[t_dry_parfum, t_aromatherapy, t_patchouli], deleted=False)
    db.session.add(g_16)
    g_17 = models.Good(product='Охлаждающий бальзам для ног', name='Бергамот и ментол', category=c_body,
                       ...
                       tags=[t_bergamot, t_menthol, t_pedicure], deleted=False)
    db.session.add(g_17)
    db.session.commit()
